...
function setup() {
  ...
  tiger = new Predator(100, 100, 5, color(200, 150, 50), 40, UP_ARROW, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, 16);
  //new predator that uses W, A, S, D for up, down, left, and right directions, respectively, space for sprint
  lion = new Predator(200, 200, 5, color(200, 200, 0), 40, 87, 83, 65, 68, 32);
